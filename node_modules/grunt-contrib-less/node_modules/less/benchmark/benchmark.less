...
div.browse {
  ...
  > div.footer {
    ...
    div.pagination {
      ...
      span.current { color: @white; background: @bg; border: 0; }
...
#sidebar {
  #actions {
    ...
    div.content {
      ...
      div.blank {
        border: 0; background: none; padding: 10px 0 0; border-top: 1px solid (@accent_colour * 0.5 + @white * 0.5);
        margin: 10px 0 0;
      }
    }
  }
...
ul.people.list {
  ...
  > li {
    ...
    border: 0; border-bottom: 1px solid (@light_grey * 0.33 + @white * 0.66);
    span.points {
      ...
      div.header {
        ...
        ul.tabs {
          ...
          li {
            margin: 0 5px 0 0;
            a {
              border: 0; background: url('/images/transparent_backgrounds/white_75.png');
              :hover { color: @black; }
            }
          }
          li.active {
...
#pages_controller.faq {
  #answers {
    ...
    h3.first { margin-top: 0; padding-top: 0; border: 0; }
  }
  #questions {
    div.content {
      padding: 20px;
    ...
    div.name {
      ...
      span.points.with_redeem {
        ...
        a.button {
          ...
          position: absolute; height: 18px; left: 0; right: 0; bottom: -19px; line-height: 18px; text-transform: uppercase; border: 0;
        }
      }
